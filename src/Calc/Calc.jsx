...
const App = () => {
  ...
  return (
    <div className="w-[20%] h-[250px] bg-[#2b2b2b] px-5 pb-5 pt-1 mb-5 mt-[10%] mx-auto box-border rounded-2xl shadow">
      <h1 className="!text-white text-center font-bold border border-slate-400 rounded-lg">
        x + y = 
      </h1>
     ...
     <div className="w-[200px] grid grid-cols-3 ">
        ...
        <button
          ...
          className="w-[127px] btn btn-success !m-1 !inline-flex"
        >
          Reset
        </button>
      </div>
      <div className="grid grid-rows-1">
        <button
          onClick={() => dispatch({ type: "+", payload: 1 })}
          className="w-[60px] btn btn-success !m-1 !inline-flex"
        >
          +
        </button>
        <button
